...
# Overview
New Models Backport is a utility library mod for Minecraft 1.20.1 (Forge). It allows map makers and resource pack creators to use modern JSON models (1.21.11+ format) in Minecraft 1.20.1. It ports the handling of the new JSON formatting so it can be natively read, loaded, and rendered.
